(module
 ...
 (export "wasmFibonacci" (func $src/wasm/index/wasmFibonacci))
 (export "replaceString" (func $src/wasm/index/replaceString))
 ...
 (func $src/wasm/index/wasmFibonacci (; 26 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  local.get $0
  i32.const 1
  i32.eq
  if
  ...
  i32.const 1
  i32.sub
  call $src/wasm/index/wasmFibonacci
  local.get $0
  i32.const 2
  i32.sub
  call $src/wasm/index/wasmFibonacci
 ...
 (func $~lib/string/String#indexOf (; 30 ;) (type $FUNCSIG$iiii) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  local.get $1
  call $~lib/rt/pure/__retain
 ...
 (func $src/wasm/index/replaceString (; 34 ;) (type $FUNCSIG$iiii) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  drop
