(module
 ...
 (import "env" "logToConsole" (func $src/wasm/index/exportLogToConsole (param i32)))
 (memory $0 1)
 ...
 (func $src/wasm/index/wasmFibonacci (; 27 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  local.get $0
  call $src/wasm/index/exportLogToConsole
  local.get $0
  i32.const 1
  i32.eq
  if
